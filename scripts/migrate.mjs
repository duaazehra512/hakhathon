...
const {
  NEXT_PUBLIC_SANITY_PROJECT_ID="ddnwsmte", // Sanity project ID
  NEXT_PUBLIC_SANITY_DATASET="production", // Sanity dataset (e.g., "production")
  NEXT_PUBLIC_SANITY_AUTH_TOKEN="skGJSBkAg3KElkWCiWjYzCqZRK0ZhYUpeBSnvYURntsrpmV3BJA76KDUHwQmJZW26zeZLS81WErbcrm9HHbi42Bltqpi8KdZ2SAraCliW8Kd7DBerCq1w2cPepu8uh0fF0vuPTIGpQj2XEMpEg4RD1314nHfZfhbTKAqx3byEuzSGCZbmoOx", // Sanity API token
